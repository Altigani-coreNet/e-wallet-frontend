                            ...
                            <tbody>
                                {products.length > 0 ? products.map((product) => (
                                    <tr key={product.id}>
                                        ...
                                        <td><span className="text-dark fw-bold">{product.product_name || product.name}</span></td>
                                        ...
                                        <td className="text-end">
                                            <Link to={`/admin/sales/products/${product.id}`} className="btn btn-sm btn-light-primary">View</Link>
                                        </td>
                                    </tr>
                                )) : (
