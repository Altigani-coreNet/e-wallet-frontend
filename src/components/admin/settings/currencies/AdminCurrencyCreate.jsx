...
const AdminCurrencyCreate = () => {
    ...
    useEffect(() => {
        setTitle(t('admin.settings.currencies.createTitle'));
        setActions(null);
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(false);
        if (response.success) {
            toast.success(t('admin.settings.currencies.createdSuccess'));
            navigate('/admin/settings/currencies');
        } else {
            toast.error(response.error || t('admin.settings.currencies.createdFailed'));
                        ...
                        <button type="submit" className="btn btn-primary" disabled={loading}>
                            {loading ? (
                                <>
                                    ...
                                    {t('admin.settings.currencies.creating')}
                                </>
                            ) : (
                                t('admin.settings.currencies.createBtn')
                            )}
                        </button>
                    </div>
                </form>
