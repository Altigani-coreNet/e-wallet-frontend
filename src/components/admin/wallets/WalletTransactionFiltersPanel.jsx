...
const WalletTransactionFiltersPanel = ({ filters, onChange, onClear }) => {
        ...
        <div className="card mb-5">
            ...
            <div className="card-body">
                <div className="row g-4">
                    ...
                    <div className="col-md-4">
                        <label className="form-label fw-bold">{t('admin.wallets.walletId')}</label>
                        <input
                            type="text"
                            className="form-control form-control-solid"
                            name="wallet_id"
...
export default WalletTransactionFiltersPanel;
