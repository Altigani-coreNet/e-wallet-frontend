...
const EXPECTED_SERIES = ['Sales', 'Purchases'];
...
const SalesChart = ({ data, hasRange, loading, activePeriod, onPeriodChange }) => {
    ...
    const chartOptions = useMemo(() => {
        ...
        return {
            ...
            stroke: {
                ...
                show: true,
                width: 3,
                colors: ['#009ef7', '#50cd89'], // Blue for Sales, Green for Purchases
            },
            xaxis: {
            ...
            <div className="card-body pb-0 pt-4">
                ...
                {isEmptyDataset && (
                    <div className="text-center mt-2">
                        <small className="text-muted">No sales or purchase data available</small>
                    </div>
                )}
            </div>
        </div>
