    ...
    React.useEffect(() => {
        ...
        setActions(
            <div className="d-flex align-items-center gap-2">
                <Link to="/merchant/payment-gateways" className="btn btn-sm btn-light">
    ...
    return (
        <div className="card">
            <div className="card-header">
                <h3 className="card-title">Payment Gateway Details</h3>
            </div>
            ...
            <div className="card-body">
                ...
                <div className="row mb-5">
                    ...
                    <div className="col-md-6">
                        <div className="mb-5">
                            <label className="form-label fw-bold">Configuration Status</label>
                            <div>
                                {paymentGateway.has_shop_config ? (
                                    <span className="badge badge-success">Configured</span>
                                ) : (
                                    <span className="badge badge-light">Not Configured - Using Defaults</span>
                                )}
                            </div>
                        </div>
                    </div>
                ...
                {Object.keys(config).length === 0 && (
                    <div className="mb-5">
                        <label className="form-label fw-bold mb-4">Configuration</label>
                        <div className="form-control form-control-solid">No custom configuration set</div>
                    </div>
                )}
            </div>
        </div>
