...
const PaymentGatewayEdit = () => {
    ...
    const fetchPaymentGateway = async () => {
        setFetching(true);
        try {
            const response = await getPaymentGateway(name);
            if (response.success) {
    ...
    const handleRemoveLogo = () => {
        setLogoFile(null);
        setLogoPreview(existingLogo ? `/${existingLogo}` : null);
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await updatePaymentGateway(name, submitData);
            if (response.success) {
                ...
                toast.error(response.error || 'Failed to configure payment gateway');
            }
        } catch (error) {
    ...
    return (
        <div className="card">
            <div className="card-header">
                <h3 className="card-title">Configure {gatewayInfo.title || gatewayInfo.name}</h3>
            </div>
                ...
                <div className="card-body">
                    ...
                    <div className="row mb-6">
                        <div className="col-12">
                            ...
                            <p className="text-muted mb-4">Configure the payment gateway settings. Leave fields empty to use default values.</p>
